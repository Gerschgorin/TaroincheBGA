 ...
 * particular, you can set here the values of variables elements defined in taroinche_taroinche.tpl (elements
...
class view_taroinche_taroinche extends game_view
{
    protected function getGameName()
    {
  	...
  	{		
        ...
        */
        ...
        $this->page->begin_block( "taroinche_taroinche", "myblock" );
        ...
        */
        ...
        $directions = array( 'P1', 'P2', 'P3', 'P4', 'P5' );
        ...
        $this->tpl['CURRENT_BID'] = self::_("Current bid");
        $this->tpl['HAND'] = self::_("Hand");
        $this->tpl['PREVIOUS_TRICK'] = self::_("Previous trick");
        $this->tpl['COINCHE'] = self::_("Coinche");
